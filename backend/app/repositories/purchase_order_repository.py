...
class PurchaseOrderRepository:
    ...
    async def filter_by_supplier(self, supplier_id: int, *, skip: int = 0, limit: int = 100) -> List[PurchaseOrder]:
        """
    ...
    async def filter_by_status(self, status: str, *, skip: int = 0, limit: int = 100) -> List[PurchaseOrder]:
        """
    ...
    async def filter_by_created_by(self, user_id: int, *, skip: int = 0, limit: int = 100) -> List[PurchaseOrder]:
        """
    ...
    async def filter_by_date_range(self, start_date: datetime, end_date: datetime, *, skip: int = 0, limit: int = 100) -> List[PurchaseOrder]:
        """
    ...
    async def filter_by_amount_range(self, min_amount: Decimal, max_amount: Decimal, *, skip: int = 0, limit: int = 100) -> List[PurchaseOrder]:
        """
    ...
    async def get_or_create(self, defaults: Optional[dict] = None, **kwargs) -> Tuple[PurchaseOrder, bool]:
        """
    ...
    async def update_or_create(self, criteria: dict, updates: dict) -> Tuple[PurchaseOrder, bool]:
        """
    ...
    async def get_pending_deliveries(self, *, skip: int = 0, limit: int = 100) -> List[PurchaseOrder]:
        """
    ...
    async def get_overdue_deliveries(self, *, skip: int = 0, limit: int = 100) -> List[PurchaseOrder]:
        """
