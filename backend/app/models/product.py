from sqlalchemy import String, Boolean, Text, ForeignKey, Numeric, Integer, Date, Index, CheckConstraint
...
class Product(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("low_stock_threshold >= 0", name="ck_low_stock_threshold_positive"),
